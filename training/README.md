...
- To fine-tune the base model on MOSE using 8 GPUs, run 
    ...
    ```python
    python training/train.py -c configs/sam2.1_training/sam2.1_hiera_b+_MOSE_finetune.yaml --use-cluster 0 --num-gpus 1
    python training/train.py -c configs/sam2.1_training/cityscapes.yaml --use-cluster 0 --num-gpus 2
    ```
