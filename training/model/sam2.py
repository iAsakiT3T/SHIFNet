...
#                 use_box_input = self.rng.random() < prob_to_use_box_input#0.5
#                 if use_box_input:
...
#         current_out["cls_embed"] = [cls_embed]
...
#             all_cls_embed.append(cls_embed)
...
#         current_out["all_cls_embed"] = all_cls_embed
